...
project_name = "World of Warcraft";  -- Put your project name here to replace all uses of World of Warcraft in strings with your projects' name.
...
elseif ( GetLocale() == "esES" ) then
	...
	FEEDBACKUI_CONFIRMATION = "Your feedback has been submitted.Thank you for helping us to improve " .. project_name .. "!"
